...
const STYLES = `
  ...
  /* ── Hero ── */
  .shop-hero {
    background: linear-gradient(135deg, #e0f2fe 0%, #fce7f3 40%, #dbeafe 100%);
  ...
  .shop-hero-sub { color: #f59e0b; font-weight: 700; font-size: 1rem; max-width: 36rem; line-height: 1.6; }
  ...
  /* ── Sidebar ── */
  .shop-sidebar-card {
    background: linear-gradient(145deg, #f0f9ff, #ede9fe);
  ...
  .shop-filter-btn.active {
    background: linear-gradient(135deg, #d946ef, #d946ef, #10b981);
    color: #fff;
  ...
  .shop-filter-btn.inactive:hover { background: #f0f9ff; }
  ...
  .shop-sort-label { font-size:0.8rem; font-weight:700; color:#3b82f6; white-space:nowrap; }
  .shop-sort-select {
  ...
  .shop-loading-dot:nth-child(1) { background:#d946ef; animation-delay:0s; }
  .shop-loading-dot:nth-child(2) { background:#d946ef; animation-delay:0.2s; }
  .shop-loading-dot:nth-child(3) { background:#10b981; animation-delay:0.4s; }
  .shop-loading p { color:#3b82f6; font-weight:700; font-size:0.95rem; }
  ...
  .shop-empty h3 { font-family:'Nunito',sans-serif; font-weight:900; font-size:1.4rem; color:#3b82f6; margin:0 0 0.5rem; }
  .shop-empty p  { color:#94a3b8; font-size:0.9rem; }
  ...
  .shop-pg-btn.active {
    background: linear-gradient(135deg, #d946ef, #d946ef);
    color: #fff;
  ...
  .shop-pg-btn.inactive:hover { background: #dbeafe; }
  ...
  .shop-pg-ellipsis {
    width: 2.75rem; height: 2.75rem;
    display: flex; align-items: center; justify-content: center;
    color: #bfdbfe; font-weight: 900; font-size: 1.1rem;
    user-select: none;
  }
  .shop-pg-info {
    text-align: center;
            ...
            <div className="shop-sidebar-card">
              <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'1.25rem' }}>
                ...
                <button
                  ...
                  style={{ fontSize:'0.78rem', fontWeight:800, color:'#d946ef', background:'none', border:'none', cursor:'pointer' }}
                >
                  Clear All
                </button>
              </div>
              <p style={{ fontSize:'0.7rem', fontWeight:700, textTransform:'uppercase', letterSpacing:'0.08em', color:'#3b82f6', marginBottom:'0.75rem' }}>
                Categories
              </p>
            ...
            <div className="shop-toolbar">
              <div>
                ...
                {!loading && totalPages > 1 && (
                  <span className="shop-toolbar-tag" style={{ background:'linear-gradient(135deg,#d1fae5,#d1fae5)', color:'#10b981', borderColor:'#86efac' }}>
                    pg {page}/{totalPages}
                  </span>
                )}
              </div>
